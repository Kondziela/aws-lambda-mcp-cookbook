...
class BaseHTTPResponse(io.IOBase):
    ...
    def getheaders(self) -> HTTPHeaderDict:
        warnings.warn(
            'HTTPResponse.getheaders() is deprecated and will be removed in urllib3 v2.6.0. Instead access HTTPResponse.headers directly.',
    ...
    def getheader(self, name: str, default: str | None = None) -> str | None:
        warnings.warn(
            'HTTPResponse.getheader() is deprecated and will be removed in urllib3 v2.6.0. Instead use HTTPResponse.headers.get(name, default).',
            category=DeprecationWarning,
            stacklevel=2,
        )
