...
class ParameterDefinition:
    ...
    def __init__(
        ...
        try:
            ...
            raise EndpointResolutionError(
                msg=f'Unknown parameter type: {parameter_type}. A parameter must be of type string, boolean, or stringarray.'
            )
        self.documentation = documentation
    ...
    def validate_input(self, value):
        ...
        if not isinstance(value, self.parameter_type):
            raise EndpointResolutionError(msg=f'Value ({self.name}) is the wrong type. Must be {self.parameter_type}.')
    ...
    def process_input(self, value):
        ...
        if value is None:
            if self.default is not None:
                return self.default
            if self.required:
                raise EndpointResolutionError(msg=f'Cannot find value for required parameter {self.name}')
