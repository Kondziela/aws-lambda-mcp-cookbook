...
def filter_python_deprecation_warnings():
    ...
    """
    warnings.filterwarnings('ignore', message='.*Boto3 will no longer support Python.*', category=PythonDeprecationWarning, module=r'.*boto3\.compat')
...
def _warn_deprecated_python():
    ...
    py_37_params = {
        ...
        'blog_link': ('https://aws.amazon.com/blogs/developer/python-support-policy-updates-for-aws-sdks-and-tools/'),
    }
    deprecated_versions = {
