...
class Session:
    ...
    def resource(
        ...
        try:
            ...
            raise UnknownAPIVersionError(service_name, api_version, ', '.join(available_api_versions))
        ...
        service_context = boto3.utils.ServiceContext(
            ...
            service_waiter_model=boto3.utils.LazyLoadedWaiterModel(self._session, service_name, api_version),
        )
