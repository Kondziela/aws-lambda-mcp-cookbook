...
class DynamoDBHighLevelResource:
    def __init__(self, *args, **kwargs):
        ...
        attr_value_shape_docs = DocumentModifiedShape(
            ...
            new_description=(
                '- The value of the attribute. The valid value types are listed in the :ref:`DynamoDB Reference Guide<ref_valid_dynamodb_types>`.'
            ),
            new_example_value=("'string'|123|Binary(b'bytes')|True|None|set(['string'])|set([123])|set([Binary(b'bytes')])|[]|{}"),
        )
        ...
        key_expression_shape_docs = DocumentModifiedShape(
            ...
            new_description=(
                'The condition(s) a key(s) must meet. Valid conditions are listed in the :ref:`DynamoDB Reference Guide<ref_dynamodb_conditions>`.'
            ),
