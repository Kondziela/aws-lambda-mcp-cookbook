...
class ResourceFactory:
    ...
    def _load_attributes(self, attrs, meta, resource_name, resource_model, service_context):
        ...
        identifiers = {i.member_name: i for i in resource_model.identifiers if i.member_name}
        ...
        def property_loader(self):
            if self.meta.data is None:
                if hasattr(self, 'load'):
                    ...
                    raise ResourceLoadException(f'{self.__class__.__name__} has no load method')
