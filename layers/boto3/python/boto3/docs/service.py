...
class ServiceDocumenter(BaseServiceDocumenter):
    ...
    def __init__(self, service_name, session, root_docs_path):
        ...
        self._USER_GUIDE_LINK = 'https://boto3.amazonaws.com/v1/documentation/api/latest/guide/resources.html'
    ...
    def _document_service_resource(self, section):
        ...
        ServiceResourceDocumenter(self._service_resource, self._session, self._root_docs_path).document_resource(service_resource_doc)
